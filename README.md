...
Add APK (https://drive.google.com/file/d/1PsqJ3CQ_XHSyLRSf2j_0eoueHI_uYIvm/view?usp=sharing) in 
the folder structure **src/test/resources/apps/android**, 
create android folder if missing and rename the .apk to - android.apk
